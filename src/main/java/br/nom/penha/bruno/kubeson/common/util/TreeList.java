...
public class TreeList<E> extends AbstractList<E> {
    ...
    static class AVLNode<E> {
         ...
         */
        private AVLNode(final Iterator<? extends E> iterator, final int start, final int end, final int absolutePositionOfParent, final AVLNode<E> prev,
        ...
        public String toString() {
            return new StringBuilder().append("AVLNode(")
