...
import br.nom.penha.bruno.kubeson.logs.model.SearchItem;
    ...
    private class LogListCell extends StackPane {
        ...
        private void createNodes() {
            ...
            if (!logLineContainer.getLogLine().isSystem()) {
                ...
                if (logLineContainer.getLogLine().getLogCategory() != null) {
                    ImageView iv = new ImageView(logLineContainer.getLogLine().getLogCategory().getSmallIcon());
                    iv.setTranslateY(3);
                    nodes.add(iv);
                    nodes.add(new Text(" "));
    ...
    private class Export {
        ...
        private PrintWriter getFileWriter(String filename) {
            ...
            fileChooser.setInitialFileName(
                    "kubeson_" + logTab.getTabLabel().getText().replace(" ", "-") + "_" + filename + "_" + dateFormatter.format(Instant.now()) + ".log.txt");
